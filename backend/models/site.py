...
class Site(Base):
    ...
    request_size_limit_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    sanitization_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    custom_blocked_patterns: Mapped[str] = mapped_column(Text, default="")
